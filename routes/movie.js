...
Router.post("/formverde",(req,res) =>{
  ...
  axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=3dfe1cc9f329824a039d8b3aaf2f814e&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&primary_release_date.gte=2012-01-01&primary_release_date.lte=2018-12-31&vote_average.gte=6&with_genres=${genero}`)
  .then((pepeResponde) => {
